//
//  AddFavoriteProductUseCaseTests.swift
//  Meli
//
...
final class AddFavoriteProductUseCaseTests {
    @Test func saveFavoriteProduct() async throws {
        // Given
    ...
    @Test func saveFavoriteProductWithProductIdEmpty() async throws {
        // Given
        let product: ProductDomainModel = .init(
            id: .empty,
            title: "Moto G34 5g 256 Gb Negro Meteorito 8 Gb Ram Motorola",
